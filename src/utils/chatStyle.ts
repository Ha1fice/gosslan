...
export const CHAT_PRESETS: ChatPreset[] = [
  ...
  },
  {
    key: "classic",
    label: "经典蓝",
    light: { mineBubble: "#dbeafe", mineText: "#1e3a8a", otherBubble: "#e7edf4", otherText: "#1f2937" },
    dark: { mineBubble: "#1d4ed8", mineText: "#ffffff", otherBubble: "#252e3b", otherText: "#e5e7eb" },
  },
  {
    key: "mint",
    label: "薄荷绿",
    light: { mineBubble: "#d1fae5", mineText: "#064e3b", otherBubble: "#e7edf4", otherText: "#1f2937" },
    dark: { mineBubble: "#065f46", mineText: "#ecfdf5", otherBubble: "#252e3b", otherText: "#e5e7eb" },
  },
  {
    key: "amber",
    label: "暖阳橙",
    light: { mineBubble: "#ffedd5", mineText: "#7c2d12", otherBubble: "#e7edf4", otherText: "#1f2937" },
    dark: { mineBubble: "#9a3412", mineText: "#fff7ed", otherBubble: "#252e3b", otherText: "#e5e7eb" },
  },
  {
    key: "celadon",
    label: "青瓷",
    light: { mineBubble: "#ccfbf1", mineText: "#134e4a", otherBubble: "#e7edf4", otherText: "#1f2937" },
    dark: { mineBubble: "#115e59", mineText: "#f0fdfa", otherBubble: "#252e3b", otherText: "#e5e7eb" },
  },
  {
    key: "rose",
    label: "樱花粉",
    light: { mineBubble: "#fce7f3", mineText: "#831843", otherBubble: "#e7edf4", otherText: "#1f2937" },
